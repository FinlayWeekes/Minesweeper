...
namespace Minesweeper.AI
{
    public class Difficulty
    {
        ...
        public Difficulty(string difficultyName)
        {
            ...
            this.easyPatterns = GetPatterns(easyNames, false);
            this.optionalPatterns = GetPatterns(optionalNames, false);
            this.essentialPatterns = GetPatterns(essentialNames, true);
        ...
        public Difficulty(int width, int height, int mineCount, List<string> easyPatternNames, List<string> optionalPatternNames, List<string> essentialPatternNames)
        {
            ...
            this.easyPatterns = GetPatterns(ListToArray(easyPatternNames), false);
            this.optionalPatterns = GetPatterns(ListToArray(optionalPatternNames), false);
            this.essentialPatterns = GetPatterns(ListToArray(essentialPatternNames), true);
            this.width = width;
            this.height = height;
        ...
        private List<Func<LogicCell, Grid, int, int, bool>> GetPatterns(string[] patternNames, bool essential)
        {
        ...
        private List<int> Get3BVValues()
        {
            ...
            using (StreamReader sr = new StreamReader(Get3BVTextFileName()))
            {
        ...
        private string Get3BVTextFileName()
        {
