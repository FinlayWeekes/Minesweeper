...
namespace Minesweeper.AI
{
    abstract class AI
    {
        ...
        protected static List<(int x, int y)> GetWallCells((int x, int y) perpCell, int x, int y, Grid grid)
        {
            ...
            {
                if (!grid.IsInBounds(wallCells[i].x, wallCells[i].y))
                {
                    wallCells.RemoveAt(i);
                    i--;
                }
            }
        ...
        protected static List<(int x, int y)> GetExtendedWallCells((int x, int y) perpCell, int x, int y, Grid grid)
        {
            int xDirection = perpCell.x - x;
            int yDirection = perpCell.y - y;
        ...
        protected static List<LogicCell> GetCornerCellIndexes(Grid grid, int xDirection, int yDirection, int x, int y)
        {
            List<LogicCell> cornerCells = new List<LogicCell>();
        ...
        protected static List<LogicCell> GetEdgeCellIndexes(Grid grid, int xDirection, int yDirection, int x, int y)
        {
            List<LogicCell> edgeCells = new List<LogicCell>();
