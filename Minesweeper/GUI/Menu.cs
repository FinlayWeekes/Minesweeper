...
namespace Minesweeper.GUI
{
    public partial class Menu : Form
    {
        ...
        private int[] constBetchelsMin = new int[] {0, 0, 0, 0, 0};
        ...
        private void OpenBoard(Difficulty difficulty)
        {
            ...
            Board board = new Board(difficulty, lightMode, name, topTimesCount);
            this.Hide();
            board.Show();
        }
        ...
        {
            if (!UpdateRecentName()) return;
            CustomForm customForm = new CustomForm(lightMode, name, topTimesCount);
            this.Hide();
            customForm.Show();
        }
        ...
        private void leaderboardBtn_Click(object sender, EventArgs e)
        {
            ...
            Leaderboards leaderboards = new Leaderboards(topTimesCount, constBetchelsMin);
            this.Hide();
            leaderboards.Show();
        }
    }
