...
namespace Minesweeper.GUI
{
    public partial class Board : Form
    {
        ...
        public Board(Difficulty Difficulty, bool LightMode)
        {
        ...
        private void PopulateMines(int firstCol, int firstRow)
        {
            ...
            if (difficulty.Custom && difficulty.EssentialPatterns == null)
            {
                grid = new Grid(width, height, firstCol, firstRow, mineCount, GetSeed());
            }
            else
            {
        ...
        private Grid GetSolvableGrid(int firstCol, int firstRow)
        {
            ...
            do
            {
                ...
                grid = new Grid(width, height, firstCol, firstRow, mineCount, seed);
        ...
        private void PopulateLightColours()
        {
            ...
            hiddenCol = ColorTranslator.FromHtml("#FEFEFE");
        ...
        private void WonGame()
        {
            ...
            Stats stats = new Stats(difficulty.Name, width, height, mineCount, Find3BV(), clickCount, time/10);
            stats.Show();
        }
