...
namespace Minesweeper.AI
{
    class Solver
    {
        ...
        public Solver(Difficulty Difficulty, Grid Grid, bool testingMode)
        {
        ...
        public bool IsSolvable()
        {
            ...
            if (TestingMode)
            {
                WriteDataToFile(Convert.ToString(grid.Find3BV()));
                return false;
            }
        ...
        {
            using (StreamWriter sw = new StreamWriter(GetTextFileName(), true))
            {
                sw.WriteLine(text);
            }
        }
        ...
        {
            return "Difficulty Data/3BV/" + difficulty.Name + "3BV.txt";
        }
    }
}